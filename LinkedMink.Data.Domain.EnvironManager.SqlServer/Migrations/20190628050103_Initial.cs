        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdateReceived = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    RelativeHumidity = table.Column<decimal>(type: "decimal(4, 1)", nullable: false),
                    Temperature = table.Column<decimal>(type: "decimal(4, 1)", nullable: false),
                    RecordedOn = table.Column<DateTime>(nullable: false),
                    HardwareDeviceId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogEntries_HardwareDevices_HardwareDeviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HardwareDevices_Host",
                table: "HardwareDevices",
                column: "Host");

            migrationBuilder.CreateIndex(
                name: "IX_LogEntries_HardwareDeviceId",
                table: "LogEntries",
